      ...
      <div v-for="(benefit, index) in benefits" :key="index" class="benefit-row">
        <template v-if="index % 2 === 0">
          ...
          <div class="benefit-image right">
            <img :src="benefit.image" :alt="benefit.title.highlight" class="image-container" />
          </div>
        </template>
...
import benefitImage1 from '@/assets/images/beneficio1.png'
import benefitImage2 from '@/assets/images/beneficio2.png'
import benefitImage3 from '@/assets/images/beneficio3.png'
import benefitImage4 from '@/assets/images/beneficio4.png'
import benefitImage5 from '@/assets/images/beneficio5.png'
...
.timeline-container::after {
  ...
  position: absolute;
  width: 4px;
  background: linear-gradient(to bottom, rgba(232, 139, 143, 0.3), #e88b8f, rgba(232, 139, 143, 0.3));
  top: 0.5em;
  bottom: 0;
  left: 50%;
  margin-left: -2px;
...
.benefit-row::after {
  ...
  z-index: 1;
  box-shadow: 0 0 0 4px rgba(232, 139, 143, 0.2);
}
